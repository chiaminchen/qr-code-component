...
- [MDN Web Docs](https://developer.mozilla.org/en-US/) - Helpful for looking up HTML/CSS documentation.
- [Tailwind CSS Documentation](https://tailwindcss.com/docs) - Excellent reference for utility classes and the new v4 features.
